...
| Test Case ID | Description               | Steps                                        | Expected Outcome                                                               | Actual Outcome |
| ------------ | ------------------------- | -------------------------------------------- | ------------------------------------------------------------------------------ | -------------- |
| TC-INT-01    | Spark-Postgres Connection | Run Spark job with empty input dir           | Spark application starts without connection errors to Postgres.                |                |
...
| Test Case ID | Description   | Steps                                                     | Expected Outcome                                                                 | Actual Outcome |
| ------------ | ------------- | --------------------------------------------------------- | -------------------------------------------------------------------------------- | -------------- |
| TC-E2E-01    | Complete Flow | 1. Run Generator<br>2. Run Spark Job<br>3. Check Postgres | Records from JSONL files appear in `ecommerce_events` table with correct values. |                |
